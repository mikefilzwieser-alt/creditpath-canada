...
• When **consumer_proposal** is **true**:
  ...
  - For building credit while consumer_proposal is true, center these secured paths in top_actions: Neo Financial secured card (https://neo.cc/refer/G3Y6L5A9), Koho secured path (https://www.koho.ca), or becoming an authorized user on another person's existing card. Frame unsecured bank cards as products most clients in Consumer Proposal are steered away from until a licensed professional clears a different approach.
