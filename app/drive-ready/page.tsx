      ...
      <main className={m}>
        ...
        <section style={{ background: NAVY_DEEP, padding: "80px 24px 100px", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ maxWidth: 900, margin: "0 auto", position: "relative", zIndex: 1, textAlign: "center" }}>
            <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.3em", textTransform: "uppercase", color: TEAL, marginBottom: 28 }}>
              Canada's Drive Ready Program 🍁
            </p>

            <h1 className={p} style={{ fontSize: "clamp(40px, 6.5vw, 80px)", fontWeight: 800, lineHeight: 1.02, letterSpacing: "-0.03em", color: "#fff", marginBottom: 24 }}>
              Your name.<br/>Zero down.<br/><span style={{ color: TEAL, fontStyle: "italic" }}>Approved.</span>
            </h1>
            ...
            <div style={{ marginTop: 48, background: "rgba(0,201,167,0.06)", border: "1px solid rgba(0,201,167,0.2)", borderRadius: 12, padding: "14px 20px", display: "inline-flex", alignItems: "center", gap: 10 }}>
              <div style={{ width: 7, height: 7, background: TEAL, borderRadius: "50%" }}></div>
              <p style={{ fontSize: 13, fontWeight: 600, color: "rgba(255,255,255,0.8)" }}>
                <strong style={{ color: "#fff" }}>Real results:</strong> Our first graduates purchased in April & May.
              </p>
            </div>
          </div>
        </section>
        ...
        <section style={{ background: NAVY, padding: "80px 24px", borderTop: "1px solid rgba(255,255,255,0.05)", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
          <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
            <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.28em", textTransform: "uppercase", color: TEAL, marginBottom: 20 }}>Why you were declined</p>
            <h2 className={p} style={{ fontSize: "clamp(28px, 4vw, 44px)", fontWeight: 800, lineHeight: 1.15, letterSpacing: "-0.02em", color: "#fff", marginBottom: 24 }}>
              The banks said no.<br/><span style={{ color: TEAL, fontStyle: "italic" }}>We know exactly why.</span>
            </h2>
            <p style={{ fontSize: 16, lineHeight: 1.8, color: "rgba(255,255,255,0.65)" }}>
              Applications get declined daily — because <strong style={{ color: "#fff" }}>nobody gave them a plan.</strong> We give you the blueprint: <span style={{ color: TEAL, fontWeight: 600 }}>a personalized credit plan.</span>
            </p>
          </div>
        </section>
        ...
        <section style={{ background: NAVY_DEEP, padding: "80px 24px", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
          <div style={{ maxWidth: 1080, margin: "0 auto" }}>
            ...
            <h2 className={p} style={{ fontSize: "clamp(28px, 4vw, 44px)", fontWeight: 800, lineHeight: 1.12, letterSpacing: "-0.02em", color: "#fff", marginBottom: 48, textAlign: "center" }}>
              Four steps. <span style={{ color: TEAL, fontStyle: "italic" }}>Here's what happens.</span>
            </h2>

            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 20 }}>
              {[
                { n: "01", t: "Reply — we take care of everything", b: "We create your login and upload your Equifax.", h: "Don't lift a finger." },
        ...
        <section style={{ background: NAVY, padding: "80px 24px", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
          <div style={{ maxWidth: 900, margin: "0 auto" }}>
            ...
            <h2 className={p} style={{ fontSize: "clamp(28px, 4vw, 44px)", fontWeight: 800, lineHeight: 1.12, letterSpacing: "-0.02em", color: "#fff", marginBottom: 40, textAlign: "center" }}>
              Three rules. <span style={{ fontWeight: 300, fontStyle: "italic", color: "rgba(255,255,255,0.6)" }}>No exceptions.</span>
            </h2>
        ...
        <section style={{ background: NAVY_DEEP, padding: "80px 24px", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
          <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
            ...
            <p className={p} style={{ fontSize: "clamp(20px, 2.6vw, 28px)", fontWeight: 700, lineHeight: 1.4, color: "#fff", fontStyle: "italic", marginBottom: 28, letterSpacing: "-0.01em" }}>
              "My credit (was) shot and I wasn't sure how I was going to get back into a vehicle. Michael took great care of me — incredibly patient with all my anxiety. As long as I make my payments on time… <span style={{ color: TEAL, fontStyle: "normal", fontWeight: 700 }}>(I had) the vehicle I wanted in a year.</span>"
            </p>
        ...
        <section style={{ background: NAVY, padding: "80px 24px", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
          <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
            ...
            <h2 className={p} style={{ fontSize: "clamp(28px, 4vw, 44px)", fontWeight: 800, lineHeight: 1.18, letterSpacing: "-0.02em", color: "#fff", marginBottom: 20 }}>
              Your score moves — <span style={{ color: TEAL, fontStyle: "italic" }}>or we work for free.</span>
            </h2>
        ...
        <section style={{ background: NAVY_DEEP, padding: "80px 24px", textAlign: "center" }}>
          <div style={{ maxWidth: 700, margin: "0 auto" }}>
            <h2 className={p} style={{ fontSize: "clamp(32px, 4.5vw, 52px)", fontWeight: 800, lineHeight: 1.08, letterSpacing: "-0.03em", color: "#fff", marginBottom: 16 }}>
              Built for Canadian families <span style={{ color: TEAL, fontStyle: "italic" }}>the system forgot.</span>
            </h2>
